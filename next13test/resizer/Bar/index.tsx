...
type Props = React.HTMLAttributes<HTMLDivElement> &
  Pick<ChildProps, 'context' | 'innerRef' | 'synthKey'> & {
    size: number;
    onClick?: () => void;
...
class BarComponent extends React.Component<Props> {
  ...
  componentDidMount() {
    console.log(`Component ${this.id} is mounting!`);
  ...
  componentWillUnmount() {
    console.log(`Component ${this.id} is unmounting`);
